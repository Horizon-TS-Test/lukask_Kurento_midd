...
var app               = require('../app');
var debug             = require('debug')('kurento-middleware:server');
var http              = require('http');
var minimist          = require('minimist');
var kurentoServerWs   = require('../config/kurento_server').kurentoServer_url_ws;
...
server.listen(port, ()=>{
    console.log("servidor Kurento midd escuchando")
});
...
function getKurentoClient(callback){
    ...
    console.log("argv.ws_uri", argv.ws_uri);
